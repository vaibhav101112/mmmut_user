package com.vaibhavguptammmut.mmmut.ui.notice;
...
import com.vaibhavguptammmut.mmmut.FullImageView;
...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.NoticeViewAdapter> {
    ...
    public class NoticeViewAdapter extends RecyclerView.ViewHolder {
        ...
        public NoticeViewAdapter(@NonNull View itemView) {
            ...
            deleteNoticeTitle = itemView.findViewById(R.id.newsTitle);
            deleteNoticeImage = itemView.findViewById(R.id.newsImage);
